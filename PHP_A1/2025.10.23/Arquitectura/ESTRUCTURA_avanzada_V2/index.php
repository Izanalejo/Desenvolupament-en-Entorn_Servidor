...
//Funcion imprime array indexado, 2 modos de impresión: modo lista ($t=1) y modo normal ($t=0)
//------------------------------------------------------------------------------------------------------------
...
<body>
    ...
    <!-- WEB Code-->
    <br>
    <h1><b>HOME:</b></h1><br><br>
    <h1><b>TESTING AND LEARNING ABOUT PHP ARRAYS:</b></h1>
    <hr><br>
    <h2>
        <<<<< Arrays indexados>>>>>
    </h2>
    <?php printArrayByIndex($arrayrrayIndexado); ?>
